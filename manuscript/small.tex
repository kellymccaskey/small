...
\usepackage{hyperref}
\hypersetup{
 pdftitle={Logit and Probit Models with Small Samples}, % title
...
\begin{center}
{\LARGE{\textbf{Logit and Probit Models with Small Samples}}\symbolfootnote[1]{We thank Alex Weisiger, Tracy George, and Lee Epstein for making their data available.
...
\section*{Predictions from Quantile Regression}


% latex table generated in R 3.2.2 by xtable 1.7-4 package
% Fri Sep 11 14:55:37 2015
\begin{table}[ht]
\centering
\begin{tabular}{ccc}
  \hline
$\xi$ & MSE inflation for Coefficients & MSE inflation for Intercept \\ 
  \hline
10 & 11.5 & 42.9 \\ 
  20 & 6.4 & 21.1 \\ 
  30 & 4.5 & 13.9 \\ 
