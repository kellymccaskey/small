...
- There is no log file, but all the figures are created and saved in the `manuscript/figs` directory.
- Note that `do-all.R` does not automatically re-compile the LaTeX manuscript, so you need to do that manually.
